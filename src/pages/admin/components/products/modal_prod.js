...
export default class Modal_Prod extends Component {
    ...
    handleSubmit = (event) => {
        ...
        axios.put(`${serverUrl}/api/product/`, formData, configHeader)
            .then(result => {
    ...
    handleAdd = (event) =>{
        ...
        axios.post(`${serverUrl}/api/product/`, formData, configHeader)
            .then(result => {
                this.setState({messenger : result.data.message , visible: true})
            });
                        ...
                        <form onSubmit={ this.props.add ? this.handleAdd : this.handleSubmit }>
                            <div className="row">
                                    <div className="col-md-4">
                                        { src ? <img src={`${serverUrl + imagesPath['one']}`} />: <img src={ imagesPath['two'] } />}
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-12">
                                                <div className="form-group">
                                                    ...
                                                    <textarea name="describe" className="form-control textarea" value = { this.state.product ? this.state.product.describe: '' } onChange={this.changetextarea}></textarea>
                                                </div>
                                            </div>
